...
<details>
  ...
  - Data de entrega para avaliação final do projeto: `16/11/2022 14:00`.
...
<details>
  ...
  - `git clone git@github.com:tryber/sd-021-a-mongodb-commerce.git`.

  - Entre na pasta do repositório que você acabou de clonar:
    - `cd sd-021-a-mongodb-commerce`
  ...
  - Usando o exemplo anterior: `git push -u origin joaozinho-sd-021-a-mongodb-commerce`

  6. Crie um novo `Pull Request` _(PR)_

  - Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-021-a-mongodb-commerce/pulls)
  ...
  - Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-021-a-mongodb-commerce/pulls) e confira se o seu _Pull Request_ está criado
